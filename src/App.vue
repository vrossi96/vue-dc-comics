<template>
   <div id="App">
      <Header :header-nav-list="navList" />
      <Jumbotron :comics-list="comics" />
      <ServicesSection :services-list="services" />
      <TopFooter :top-footer-list="topFooterList" />
      <BottomFooter :social="social" />
   </div>
</template>
